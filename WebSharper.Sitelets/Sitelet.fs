    ...
    let Box (sitelet: Sitelet<'T>) : Sitelet<obj> =
        {
            ...
            Controller =
                { Handle = fun ctx a ->
                    ...
                    sitelet.Controller.Handle ctx (unbox a)
                }
        }
    ...
    let Unbox<'T when 'T : equality> (sitelet: Sitelet<obj>) : Sitelet<'T> =
        {
            ...
            Controller =
                { Handle = fun ctx a ->
                    ...
                    sitelet.Controller.Handle ctx (box a)
                }
        }
